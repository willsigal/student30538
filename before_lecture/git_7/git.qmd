...
* Cheatsheet **[here](https://training.github.com/downloads/github-git-cheat-sheet/)**
...
Remark: every git repo has a hidden `.git` folder containing the database
...
![](img/file_lifecycle.png){fig-align="center"}
...
* Stage the already tracked files and then commit in one step
...
* See more examples **[here](https://github.com/github/gitignore)**
* Github's **[recommendation](https://github.com/github/gitignore/blob/main/Python.gitignore)** for Python. We haven't tested it yet.
...
::: {.notes .content-visible unless-profile="before_lecture"}
